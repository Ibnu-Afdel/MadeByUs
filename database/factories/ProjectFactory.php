...
class ProjectFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        // Pick an enum instance for status so the model cast works as expected.
        $status = fake()->randomElement(ProjectStatus::cases());

        // Only set published_at when the project is approved. This keeps
        // the data consistent with the project's status and with the
        // Project model's enum cast.
        $publishedAt = $status === ProjectStatus::APPROVED
